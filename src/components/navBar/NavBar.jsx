        ...
        return (
            <>
                ...
                <div className={`md:flex ${isOpen ? 'flex' : 'hidden'} flex-col md:flex-row items-center bg-blue-900 bg-opacity-90 p-4 absolute top-24 left-0 w-full space-y-4 md:space-y-0 z-10`}>
                    <h2 className="text-2xl text-white hover:text-yellow-400">Write me</h2>
                    <h2 className="text-2xl text-white hover:text-yellow-400">Socials</h2>
                    <h2 className="text-2xl text-white hover:text-yellow-400">Service</h2>
                    <h2 className="text-2xl text-white hover:text-yellow-400">Portfolio Project</h2>
                </div>

                {/* Pulsanti di Connessione in una Colonna su Mobile */}
                <div className={`md:flex ${isOpen ? 'flex' : 'hidden'} flex-col md:flex-row items-center bg-blue-900 bg-opacity-90 p-4 absolute top-72 left-0 w-full space-y-4 md:space-y-0 z-10`}>
                    <ConnectEVM />
                    <ConnectSolana />
                </div>
            </>
